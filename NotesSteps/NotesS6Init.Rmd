...
stargazer(m1, title = "Results of regression with dummies, orig def. p1", type = 'text')
stargazer(m2, title = "Results of regression with dummies, orig def. p2", type = 'text')
stargazer(m3, title = "Results of regression with dummies, orig def. p3", type = 'text')
```